...
yurikorobot_IMG = "https://telegra.ph/file/67b63b46d16430fb9095d.jpg"

PM_START_TEXT = """
👋 Hey [.](https://telegra.ph/file/2f999bf8239f3f43245ec.mp4) 
 *I'Aᴍ Aɴ Aɴɪᴍᴇ-Tʜᴇᴍᴇ Mᴀɴᴀɢᴇᴍᴇɴᴛ Bᴏᴛ*
 *Aᴍ Vᴇʀʏ Fᴀꜱᴛ Aɴᴅ  Mᴏʀᴇ Eꜰꜰɪᴄɪᴇɴᴛ  I Pʀᴏᴠɪᴅᴇ Aᴡᴇꜱᴏᴍᴇ  Fᴇᴀᴛᴜʀᴇꜱ!*
 *Powerd by @Phoenix_Empire*
"""
...
buttons = [
    ...
    [
        InlineKeyboardButton(text="Sᴜᴍᴍᴏɴ Mᴇ", url="http://t.me/Iruyambot?startgroup=true"),
    ],
]
...
def yurikorobot_about_callback(update, context):
    ...
    if query.data == "yurikorobot_":
        query.message.edit_text(
            text=""" *『【𝐈𝐑𝐔𝐘𝐀𝐌】』* - `A bot to manage your groups with additional features!`
            \n`Here the basic help regarding use of 『【𝐈𝐑𝐔𝐘𝐀𝐌】』.`
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="Bᴜɢ'ꜱ", url="t.me/CFC_BOT_SUPPORT"
                        ),
                        InlineKeyboardButton(
                            text="Nᴇᴛᴡᴏʀᴋ", url="https://t.me/PHOENIX_EMPIRE"
                        ),
                    ],
        ...
        query.message.edit_text(
            ...
            f"\n `Than send` `/admincache@Iruyambot` `in that chat to refresh admin list in My database.`\n"
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 ...
                 [
                    InlineKeyboardButton(text="Sᴜᴘᴘᴏʀᴛ", url="t.me/CFC_BOT_SUPPORT"),
                    InlineKeyboardButton(text="Cʀᴇᴅɪᴛ", url="t.me/CFC_BOT_SUPPORT"),
                 ],
                 [
                    InlineKeyboardButton(text="Back", callback_data="yurikorobot_back"),
        ...
        query.message.edit_text(
            ...
            f"\n `Congragulations, Iruyambot now ready to manage your group.`"
            f"\n\n*Admin Tools*"
        ...
        query.message.edit_text(
            ...
            f"\n\n `3.) add` @Iruyambot `to your group:`"
            f"\n\n `4.) turn on the video chat first before start to play music.`"
            f"\n\n *Lets Enjoy The Yuriko Music And Join Support Group @CFC_BOT_SUPPORT*"
            f"\n\n* POWERD BY PHOENIX EMPIRE*",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="Back", callback_data="yurikorobot_back")]]
        ...
        query.message.edit_text(
            text=f"<b> CREDIT FOR Iruyambot DEV'S</b>\n"
            
            f"\n` Here Some Developers Helping in Making The Iruyambot`",
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="KIRA", url="t.me/CFC_BOT_SUPPORT"),
                    InlineKeyboardButton(text="Bazi", url="t.me/BAZIGARYT"),
                 ],
                 [
                    InlineKeyboardButton(text="Heyaaman", url="t.me/heyaaman"),
                    InlineKeyboardButton(text="CFC BOTS", url="https://t.me/cfc_bot_support"),
                 ],
                 [
                    InlineKeyboardButton(text="Back", callback_data="yurikorobot_basichelp"),
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..😻 I'm *Iruyambot*
                 \nHere is the [🔥owner🔥](https://t.me/kirarealdeathgod) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
